module Hydranorth
  class GenericFilePresenter
    ...
    self.terms = [:title, :creator, :contributor, :subject, :resource_type, :language, :identifier, :spatial, :temporal, :description, :date_created, :license, :rights, :is_version_of, :source, :related_url]
