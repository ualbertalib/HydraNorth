module Blacklight::BrowseHelperBehavior
  ...
  # @param [Hash] options
  # @return String
  def render_browse_partials fields = facet_field_names, options = {}
  ...
  def render_facet_value(facet_field, item, options ={})
    ...
    content_tag(:span, :class => "facet-label") do
      link_to_unless(options[:suppress_link], facet_display_value(facet_field, item), catalog_path(params[:id]), :class=>"facet_select")
